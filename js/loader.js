...
if(isCheckUrl()){
    var $BtnWrap=$("<div id='haitou-GZSBUCK'></div>").appendTo("body");
...
var haitou={
	signHtml:	"<div class='haitou-login-box signin'><h3>登录</h3><div class='single-panel-body'>"
            ...
            +	"</div>"
    		+	"<div class='haitou-login-box register'><h3>注册</h3><div class='single-panel-body'>"
			+	"<div class='form-group'><div class='input-group'>"
            +   "	<span class='input-group-addon'><i class='fa fa-user'></i></span>"
            +   "    <input class='form-control' type='text' placeholder='输入用户名/邮箱' name='login_name' required=''>"
            +   "</div></div></div>"
